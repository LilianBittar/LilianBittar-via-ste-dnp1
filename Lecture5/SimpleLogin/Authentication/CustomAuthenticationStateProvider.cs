...
namespace S5_SimpleLogin.Authentication {
...
public class CustomAuthenticationStateProvider : AuthenticationStateProvider {
	...
	public void ValidateLogin(string username, string password) {
		...
		if (string.IsNullOrEmpty(username)) throw new System.Exception("Enter username");
		if (string.IsNullOrEmpty(password)) throw new System.Exception("Enter password");
